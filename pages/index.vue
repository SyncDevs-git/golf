        ...
        <div class="rounded-[20px] p-5 shadow-md bg-white">
          <div class="flex flex-col items-center gap-3">
            <img
              ...
              alt="Avatar"
              class="w-[112px] h-[112px] rounded-full"
            />
            <h2
              class="font-playfair font-bold text-base text-gray-light mb-[30px]"
            >
              Hello, <span class="text-black">Smith</span>
            </h2>
            <div class="flex flex-col gap-2 w-full text-center">
              <div
                class="flex items-center justify-between gap-1 py-[15px] border-t border-dashed border-gray-light"
              >
      ...
      <div class="col-span-9">
        ...
        <div class="scroll">
          ...
          >
            ...
            <template #footer>
              <div
                class="bg-sonfSliver py-[23px] rounded-[10px] text-center mt-[30px]"
              >
                <div class="max-w-[588px] mx-auto">
                  ...
                  <div
                    class="font-playfair font-extrabold text-xl leading-[153%] text-black mb-[5px]"
                  >
                    Keep Grinding
                  </div>
                  <p
